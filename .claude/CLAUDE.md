...
## 25. 설치된 스킬 현황 (66개, 2026-07-23 기준)
...
### 기타 (4개)
`ad-studio` · `ouroboros` · `hwpx` · `ppt-code-format`
...
## 35. 아이캔노트(ICanNote) — 필기·판서·원격수업 프로그램

> 공식 커뮤니티: https://cafe.naver.com/icannote
> 문의: icannote@naver.com
> 설치 버전: v2.027 (베타 최신: v2.379)
> 멤버: 89,314명

**전자칠판·원격수업·태블릿 필기**에 특화된 한국산 Windows 프로그램. 학원·교습소·인강 제작에 널리 사용됨.

### 구성 제품

| 제품 | 설명 |
|---|---|
| **아이캔노트** | 핵심 필기·판서 도구. 태블릿 펜 입력, 레이어, 도형 지원 |
| **아이캔스크린** | 화면 캡처·녹화 + 판서 오버레이 |
| **아이캔줌잇** | 화면 확대·포인터 강조 |
| **아이캔VOD** | 강의 영상 녹화·편집 |
...
## 마지막 세션 ID
- **세션 ID:** `7061a903-67a7-4107-8b45-7d6fa4732495`
- **시작:** 2026-07-23 12:22 UTC
